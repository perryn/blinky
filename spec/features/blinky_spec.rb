  ...
  describe "Blinky" do
      ...
      describe "that has autodetected a device" do
        ...
        before(:each) do
          ...
          @indicator = Blinky::Indicator.new("#{File.dirname(__FILE__)}/fixtures/device_recipes/**/*.rb")
        end
        ...
        describe "that fails autodetected a device" do
          ...
          it "will complain" do
            ...
            lambda{Blinky::Indicator.new("#{File.dirname(__FILE__)}/fixtures/device_recipes/**/*.rb")}.should raise_error("foo")                
          end
